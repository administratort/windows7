...
#define FFMPEG_CONFIGURATION "--arch=arm --cpu=cortex-a8 --enable-neon --enable-thumb --disable-gpl --disable-nonfree --enable-runtime-cpudetect --disable-gray --disable-swscale-alpha --disable-programs --disable-ffmpeg --disable-ffplay --disable-ffprobe --disable-ffserver --disable-doc --disable-htmlpages --disable-manpages --disable-podpages --disable-txtpages --disable-avdevice --enable-avcodec --enable-avformat --enable-avutil --enable-swresample --enable-swscale --disable-postproc --disable-avfilter --disable-avresample --disable-network --disable-d3d11va --disable-dxva2 --disable-vaapi --disable-vda --disable-vdpau --disable-videotoolbox --disable-encoders --disable-decoders --enable-decoder=aac --enable-decoder=mp3 --enable-decoder=ac3 --enable-decoder=eac3 --enable-decoder=truehd --enable-decoder=mlp --enable-decoder=dca --enable-decoder=vorbis --enable-decoder=opus --enable-decoder=amrnb --enable-decoder=amrwb --enable-decoder=flac --enable-decoder=alac --enable-decoder=h263 --enable-decoder=h264 --enable-decoder=hevc --enable-decoder=vc1 --enable-decoder=vp8 --enable-decoder=vp9 --enable-decoder=mpeg4 --enable-decoder=mpegvideo --enable-decoder=mpeg2video --disable-hwaccels --disable-muxers --disable-demuxers --disable-parsers --enable-parser=aac --enable-parser=ac3 --enable-parser=h263 --enable-parser=h264 --enable-parser=hevc --enable-parser=opus --enable-parser=flac --enable-parser=vc1 --enable-parser=vp8 --enable-parser=vp9 --enable-parser=mpeg4video --enable-parser=vorbis --enable-bsfs --disable-bsf=chomp --disable-bsf=dca_core --disable-bsf=dump_extradata --disable-bsf=hevc_mp4toannexb --disable-bsf=imx_dump_header --disable-bsf=mjpeg2jpeg --disable-bsf=mjpega_dump_header --disable-bsf=mov2textsub --disable-bsf=mp3_header_decompress --disable-bsf=mpeg4_unpack_bframes --disable-bsf=noise --disable-bsf=remove_extradata --disable-bsf=text2movsub --disable-bsf=vp9_superframe --disable-protocols --disable-devices --disable-filters --disable-iconv --disable-audiotoolbox --disable-videotoolbox --enable-asm --enable-vfp --enable-neon --disable-linux-perf --disable-bzlib --prefix=/exdisk/exhome/wanxin/FFmpeg/oppo-build/build/ffmpeg-armv7a/output --cross-prefix=arm-linux-androideabi- --enable-cross-compile --target-os=linux --enable-pic --enable-asm --enable-inline-asm --enable-optimizations --disable-debug --enable-small --extra-cflags='-O3 -Wall -pipe -std=c99 -ffast-math -fstrict-aliasing -Werror=strict-aliasing -Wno-psabi -Wa,--noexecstack -DANDROID -DNDEBUG -march=armv7-a -mcpu=cortex-a8 -mfpu=vfpv3-d16 -mfloat-abi=softfp -mthumb' --extra-ldflags=' -Wl,--fix-cortex-a8'"
#define FFMPEG_LICENSE "LGPL version 2.1 or later"
#define CONFIG_THIS_YEAR 2018
#define FFMPEG_DATADIR "/exdisk/exhome/wanxin/FFmpeg/oppo-build/build/ffmpeg-armv7a/output/share/ffmpeg"
#define AVCONV_DATADIR "/exdisk/exhome/wanxin/FFmpeg/oppo-build/build/ffmpeg-armv7a/output/share/ffmpeg"
